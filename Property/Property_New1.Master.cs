    ...
    public partial class Property_New1 : System.Web.UI.MasterPage
    {
        ...
        private void SetValuesFaceBookShare()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                fbProprtyUrl.Content = string.Format("http://vikashagroup.com//PropertyDetails.aspx?MLSID={0}&PropertyType={1}", dt.Rows[0]["MLS"].ToString(), dt.Rows[0]["pType"].ToString());
                //fbProprtySiteName.Content = "";
        ...
        private void BindMenusList()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                StrMenu.Append("<li class='test' style='background:none;'><a href='../seller.aspx' title='Seller'>Seller</a></li>");
                StrMenu.Append("<li class='test' style='background:none;'><a href='../buyer.aspx' title='Buyer'>Buyer</a></li>");
                ...
                StrMenu.Append("<li class='test' style='background:none;'><a href='Featured_Properties.aspx' title='Featured Listings'>Featured Listings</a></li>");
