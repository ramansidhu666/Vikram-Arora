...
<script>
    ...
    $(document).ready(function () {
        $("#shareBtn").click(function () {
            ...
            var URL = 'http://vikashagroup.com/PropertyDetails.aspx?MLSID=' + MLSID + '&PropertyType=' + PropertyType;
                    ...
                    <div class="col-md-4 col-sm-4">
                     ...
                     <img alt="" src="images/client_img.jpg" />
                        ...
                        <div class="roco_pro_info">
                            <h2>
                                <span>Vikram Arora & Natasha Arora</span></h2>
                               <p>Sales Representative</p>
                            <asp:Label CssClass="email_profile_r" ID="lblemail" runat="server"></asp:Label>
                            <span class="email_profile_r">Call Vikram: 647-534-4924</span>
                             <span class="email_profile_r">Call Natasha: 647-267-1048</span>
                        </div>
                    </div>
