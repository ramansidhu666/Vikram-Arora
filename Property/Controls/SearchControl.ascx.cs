    ...
    public partial class SearchControl : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                Session["keyword"] = Request.QueryString["keyword"];
        ...
        void SearchResidentialProperties()
        {
            try
            {
                ...
                else if (Convert.ToString(Session["QueryString"]) == "Residential" && Session["Municipality"] != "")
                {
                    ...
                    {
                        dt = mlsClient.GetResidentialProperties(Session["Municipality"].ToString(), keyword.ToString(), "0", "0", "0", "0", "0");
                    }
                    else
                    {
        ...
        void SearchCommercialProperties()
        {
            try
            {
...

                {
                    ...
                    if (keyword != null && keyword != "")
                    {
                        dt = mlsClient.GetAllCommercialProperties(Session["Municipality"].ToString(), keyword.ToString(), "0", "0", "0", "0");
                    }
                    else
                    {
            ...
            try
            {
                ...
                else if (Convert.ToString(Session["QueryString"]) == "Condo" && Session["Municipality"] != null)
                {
                    ...
                    if (keyword != null && keyword != "")
                    {
                        ...
                        dt = mlsClient.GetProperties_Condo(Session["Municipality"].ToString(), keyword.ToString(), "0", "0", "0", "0", "0");
                    }
                    else
                    {
        ...
        void ResidentialGrid(DataTable dt)
        {
            try
            {
        ...
        void CommercialGrid(DataTable dt)
        {
            try
            {
